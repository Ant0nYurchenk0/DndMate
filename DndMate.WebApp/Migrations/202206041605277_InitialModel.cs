    ...
    public partial class InitialModel : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        CharacterId = c.String(nullable: false, maxLength: 128),
                        GamespaceId = c.Int(nullable: false),
                        Id = c.Int(nullable: false),
                        CharacterClass = c.Int(nullable: false),
                        Level = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.CharacterId, t.GamespaceId })
                .ForeignKey("dbo.AspNetUsers", t => t.CharacterId, cascadeDelete: true)
